...
<center><h1 style="margin:0;padding:15px;cursor:default;font-family:微软雅黑,黑体,宋体;">H5服务详情  </h1></center>
...
<div class="mini-splitter" style="width:100%;height:80%;">
    <div size="50" showCollapseButton="true">
        <div class="mini-fit">
            <ul id="caseIdTree" class="mini-tree" style="width:100%;" url="subs/service.txt"
...
<script type="text/javascript">
    ...
    tree.on("nodeselect", function (e) {
        if (e.node._level>0) {
            ...
            servicePerformanceTree.load("statistics/loadDataByService.do?service_id=" + serviceId);
