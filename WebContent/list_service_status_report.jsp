...
<center><h1 style="margin:0;padding:15px;cursor:default;font-family:微软雅黑,黑体,宋体;">Service性能报告</h1>  </center>
...
<div class="mini-splitter" style="width:100%;height:80%;">
    <div size="50" showCollapseButton="true">
        <div class="mini-fit">
            <ul id="caseIdTree" class="mini-tree" style="width:100%;" url="list_service_status_statistics/loadServiceMenu.do"
        ...
        <div class="mini-fit">
            ...
            <div id="servicePerformance" class="mini-treegrid" style="width:100%;height:100%;"
                ...
                <div property="columns">
                    ...
                    <div field="count" width="80">总次数</div>

                    <div field="successTotalNumber" width="80">这种类型次数</div>
                    <div field="successRate" width="80">占比</div>
...
<script type="text/javascript">
    ...
    tree.on("nodeselect", function (e) {
        ...
        if (e.node._level>1) {
            ...
            servicePerformanceTree.load("list_service_status_statistics/loadDataByService.do?service_id=" + serviceId);
